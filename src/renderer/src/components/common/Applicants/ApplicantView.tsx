...
export default function ApplicantsView({ phase }: ApplicantsViewProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <ScrollArea className="h-[calc(100vh-256px)] rounded-md">
        <Card>
            ...
            <div className="w-fit p-0 bg-transparent shadow-none">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-foreground">
                  {loadingApplicants
                    ? "Cargando aspirantes..."
                    : `Total de aspirantes: ${filteredAndSortedApplicants.length}`}
                </span>
              </div>
            </div>
            <ApplicantsForm
                ...
                {user?.role === "admin" && (
                  <ConfirmDeleteDialog
                    ...
                    trigger={
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        disabled={filteredAndSortedApplicants.length === 0}
                      >
                  ...
                  >
                    <div className="space-y-2 text-center">
                      <div className="space-y-2 text-center">
                        <p>
                          ¿Seguro que deseas eliminar <strong>todos los aspirantes</strong> de esta
                          fase?
                        </p>
                        <p>
                          Esta acción también eliminará los{" "}
                          <strong>registros asociados en fases posteriores</strong>
