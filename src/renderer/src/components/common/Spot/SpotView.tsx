                ...
                <div className="flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-foreground">
                      {loadingSpots
                        ? "Cargando plazas..."
                        : `Total de registros: ${filteredAndSortedSpots.length}`}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <UsersIcon className="h-4 w-4 text-muted-foreground" />
                    <span className="text-sm font-medium text-foreground">
                      {loadingSpots ? "Cargando..." : `Plazas disponibles: ${totalAvailableSpots}`}
                    </span>
                  </div>
                </div>
              </Card>
                  ...
                  {user?.role === "admin" && (
                    <ConfirmDeleteDialog
                      ...
                      trigger={
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          disabled={filteredAndSortedSpots.length === 0}
                        >
                    ...
                    >
                      <div className="space-y-2 text-center">
                        <p>
                          ¿Seguro que deseas eliminar <strong>todas las plazas</strong> de esta
                          fase?
                        </p>
