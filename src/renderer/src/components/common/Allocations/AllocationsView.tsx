        ...
        <Card>
          <CardHeader className="flex justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              {user?.role === "admin" && (
                <>
                  {loadingApplicants || loadingSpots ? (
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          onClick={() => {
                      ...
                      <TooltipContent>
                        <p>Cargando aspirantes y plazas...</p>
                      </TooltipContent>
                    </Tooltip>
                  ) : (
                    <Button
                      ...
                      disabled={
                        filteredAndSortedAllocations.length > 0 || loadingApplicants || loadingSpots
                      }
                    >
                      <Play className="h-4 w-4" />
                      Otorgar
                  ...
                  >
                    ...
                    <p className="text-center text-sm text-muted-foreground">
                      ...
                      otorgamiento de plazas. Por favor, revisa los datos antes de continuar.
                    </p>
                  </ConfirmDeleteDialog>
                </>
              )}
