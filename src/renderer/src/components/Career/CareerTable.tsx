        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center px-2">
            <div className="flex items-center space-x-3">
              <Button
                variant={'outline'}
                size="sm" onClick={() => goToPage(currentPage - 1)}
                disabled={filteredAndSortedCareers.length === 0 || currentPage === 1}
              >
                Anterior
              </Button>
              {totalPages === 0 ? (
              ...
              <Button
                ...
                disabled={filteredAndSortedCareers.length === 0 || currentPage === totalPages}>
                Siguiente
              </Button>
            </div>
