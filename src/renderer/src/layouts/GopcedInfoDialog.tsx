      ...
      <DialogContent className="sm:max-w-3xl w-[95%] max-h-[90vh] p-4">
        <DialogHeader>
          <div className="flex items-center gap-3">
            <img src={logo} alt="GOPCED" className="size-7" />
          ...
          <div className="space-y-6">
            <Card>
              <CardContent>
                ...
                <p className="mt-2 text-sm leading-6">
                  ...
                  es un sistema desarrollado para la Universidad Central &quot;Marta Abreu&quot; de
                  Las Villas que automatiza el proceso de otorgamiento de plazas para las
            ...
            <Card>
              <CardContent>
                ...
                <ul className="mt-2 ml-5 list-disc text-sm leading-6">
                  ...
                  <li>
                    <strong>Aspirantes:</strong> CI, nombre, apellidos, nota, municipio, género y
                    hasta 3 opciones de plaza (mínimo 1, máximo 3), sin repeticiones entre opciones.
                  </li>
                </ul>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                <div className="mt-3 space-y-3 text-sm leading-6">
                  <div>
                    ...
                    <p className="mt-1">
                      Todos los aspirantes con al menos una solicitud se ordenan por nota
                      (descendente) y se otorgan plazas según disponibilidad y preferencia.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      Se ofertan las plazas restantes. Los aspirantes vuelven a presentar opciones
                      entre las plazas disponibles; la institución puede añadir o editar plazas.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      Otorgamiento manual a aspirantes ordenados por nota; el operador selecciona la
                      plaza disponible adecuada. Finaliza el proceso.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent>
                ...
                <p className="mt-2 text-sm leading-6">
                  Todos los registros (Carreras, Ubicaciones, Plazas, Aspirantes, Otorgamientos) son
                  visibles en tablas con búsqueda y filtros. Los listados y consultas relevantes
                  pueden exportarse a PDF por fase o de forma consolidada.
                </p>
            ...
            <Card>
              <CardContent>
                ...
                <p className="mt-2 text-sm leading-6">
                  Panel con indicadores por fase: fase actual, top 5 aspirantes, top 10 carreras más
                  demandadas (todas las opciones 1–3 consideradas), total aspirantes, promedio de
                  notas, plazas disponibles, plazas otorgadas y plazas restantes.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                ...
                <ul className="mt-2 ml-5 list-disc text-sm leading-6">
                  <li>
                    <strong>Administrador:</strong> control total (CRUD completo, ejecución de
                    otorgamientos, eliminaciones masivas).
                  </li>
                  <li>
                    <strong>Supervisor / Viewer:</strong> acceso limitado (sin ejecución de
                    otorgamientos y sin eliminaciones masivas).
                  </li>
                </ul>
              </CardContent>
            </Card>
