...
const api = {
  ...
  deleteAssignment: (id: number) => ipcRenderer.invoke('assignment:delete', id),
  ...
  deleteSpot: (id: number) => ipcRenderer.invoke('spot:delete', id),
  ...
  getUserByUsername: (username: string) => ipcRenderer.invoke('user:getByUsername', username),
